...
//        panel.setLayout(new MigLayout("flowx"));
    ...
    public void hargamodal(int index, String tanggal1, String tanggal2, String tahun, String bulan, String tanggal){
        try{
            Connection c = Koneksi1.getKoneksi();
            Statement s = c.createStatement();
            if(index == 1){
                String sql = "SELECT SUM(harga_total) as I from tb_supplier where tanggal between '"+tanggal1+"' And '"+tanggal2+"'";
                ...
                String sql = "SELECT SUM(harga_total) as I from tb_supplier where year(tanggal) ='"+tahun+"' And month(tanggal) ="+bulan+"";
                ResultSet r = s.executeQuery(sql);
                if(r.next()){
                    modal1 = r.getInt("I");
                }else{
                ...
                String sql = "SELECT SUM(harga_total) as I from tb_supplier where tanggal = '"+tanggal+"'";
                ResultSet r = s.executeQuery(sql);
                if(r.next()){
                    modal1 = r.getInt("I");
                }else{
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(160, 140, 26));
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        ...
        try{
            ...
            hargamodal(1,tgl1,tgl2,"","","");
            int modal = modal1;
            String report = ("C:\\Users\\fauzu\\Documents\\NetBeansProjects\\Laporan\\Laporan\\CoffeShopSarena\\src\\report\\reportPenjualan.jrxml");
            HashMap hash = new HashMap();
            hash.put("tgl1", tgl1);
            hash.put("tgl2", tgl2);
            hash.put("modal", modal1);
    ...
    private void btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn2ActionPerformed
        // TODO add your handling code here:
        try{
            String report = ("C:\\Users\\fauzu\\Documents\\NetBeansProjects\\Laporan\\Laporan\\CoffeShopSarena\\src\\report\\reportPenjualan2.jrxml");
            DateFormat FormatTahun = new SimpleDateFormat("yyyy");
            Calendar kalender = Calendar.getInstance();
            String tahun = FormatTahun.format(kalender.getTime());
            HashMap hash = new HashMap();
            ...
            bulan(month);
            String bulan = String.valueOf(this.bulan);
            hargamodal(2,"","",tahun,bulan,"");
            int modal = modal1;
    ...
    private void btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn3ActionPerformed
        // TODO add your handling code here:
        try{
            String report = ("C:\\Users\\fauzu\\Documents\\NetBeansProjects\\Laporan\\Laporan\\CoffeShopSarena\\src\\report\\reportPenjualan4.jrxml");
            HashMap hash = new HashMap();
            hargamodal(3,"","","","",tanggal());
            int modal = modal1;
